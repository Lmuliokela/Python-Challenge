...
election_data = os.path.join("/Users/leahmuliokela/Documents/Resources","election_data.csv")
...
output_file = os.path.expanduser("~/Documents/election_analysis/election_analysis.txt")
