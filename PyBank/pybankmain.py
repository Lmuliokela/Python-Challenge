...
budget_data = os.path.join("/Users/leahmuliokela/Documents/Resources","budget_data.csv")
...
output_file = os.path.expanduser("~/Documents/financial_analysis/financial_analysis.txt")
